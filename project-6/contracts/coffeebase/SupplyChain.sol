...
// Import Ownable.sol from the coffeecore directory
import "../coffeecore/Ownable.sol";

// Import role contracts from the coffeeaccesscontrol directory
...
contract SupplyChain is Ownable, ConsumerRole, DistributorRole, FarmerRole, RetailerRole {
    ...
    function purchaseItem(uint _upc) onlyConsumer payable public received(_upc)
        // Call modifier to check if upc has passed previous supply chain stage
        // Access Control List enforced by calling Smart Contract / DApp
    {
    ...
    )
    {
        ...
        (
            ...
            item.productNotes,//3
            item.productPrice,//4
            uint(item.itemState),//5
            item.distributorID,//6
            item.retailerID,//7
            item.consumerID//8
        );
    }
